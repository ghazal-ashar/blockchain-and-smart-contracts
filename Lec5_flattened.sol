...
abstract contract ERC20 is Context, IERC20, IERC20Metadata, IERC20Errors {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        uint256 fee_value = (value*fee)/100;
        uint256 amount_after = value - fee_value;

        // uint256 burn_value = (value*5)/100;
        // uint256 mint_value = (value*10)/100;

        // value = amount_after - burn_value;
        value = amount_after;

        // _burn(from, burn_value);
        // emit TokensMinted(from, value); 
        // _mint(from, mint_value);
        // emit TokensBurned(from, value);       
        _update(from, to, value);
        _update(from, beneficiary, fee_value);
...
contract Staking {
    ...
    uint8 public constant reward = 5;
